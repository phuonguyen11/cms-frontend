      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">        
                <h5>Trụ Sở : 85A Trương Văn Thành, phường Hiệp Phú , Tp. Thủ Đức, Tp. HCM</h5>
                <h5>VPGD HCM : Lầu 7 - Master Building, 41-43 Trần Cao Vân , phường 6, quận 3, Tp.HCM</h5>
                <h5>VPGD Japan : Tokyo, Koto, Kameido 5-13-9-1F</h5>
                <h5>VPGD Singapore : 111 North Bridge Road, #21-01 Peninsula Plaza, Singapore</h5>
                <h5>VPGD Australia : 999 Whitehorse Road , Box Hill , Melbourne , Australia</h5>
                <h3>Email : info@stechvn.org</h3>
              </div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; 2021 STECH INC. All rights reserved.</div>
